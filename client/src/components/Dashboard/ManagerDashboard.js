                ...
                <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                    <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li>
								<Link to="/manager" data-bs-toggle="collapse" className="nav-link text-white px-0 align-middle">
									<i className="fs-4 bi bi-house"></i> <span className="ms-1 d-none d-sm-inline">Home</span> </Link>
							</li>
                            <li>
                                <Link to="/manager/artists" className="nav-link px-0 align-middle text-white">
                                    <i className="fs-4 bi bi-universal-access"></i> <span className="ms-1 d-none d-sm-inline">Artists</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/manager/music" className="nav-link px-0 align-middle text-white">
                                    <i className="fs-4 bi bi-boombox"></i> <span className="ms-1 d-none d-sm-inline">Music</span>
                                </Link>
                            </li>
                            <li>
